...
schema = [
    ...
    {'Name': 'p_value_significant', 'Type': 'string', 'Comment': 'is beta significant. Computed from reconstructed critical values, not the paper. From paper, see variable target'},
    ...
    {'Name': 'sign_significant', 'Type': 'string',
     'Comment': 'if sign_of_effect is INSIGNIFICANT then False else True'},
