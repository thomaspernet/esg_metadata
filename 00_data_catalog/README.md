...
| 29 | mid_year                                            | int         | mid year                                                                                                                                |
| 30 | last_date_of_observations                           | int         | last date of observations                                                                                                               |
| 31 | kyoto                                               | varchar(3)  | kyoto                                                                                                                                   |
| 32 | financial_crisis                                    | varchar(3)  | financial crisis                                                                                                                        |
| 33 | windows                                             | int         | windows                                                                                                                                 |
...
| 44 | target                                              | string      | indicate wheither or not the coefficient is significant. based on stars                                                                 |
| 45 | p_value_significant                                 | string      | is beta significant. Computed from reconstructed critical values, not the paper. From paper, see variable target                        |
| 46 | sign_positive                                       | string      | if sign_of_effect is POSITIVE then True                                                                                                 |
| 47 | sign_negative                                       | string      | if sign_of_effect is NEGATIVE then True                                                                                                 |
| 48 | lag                                                 | string      | the table contains lag or not                                                                                                           |
| 49 | interaction_term                                    | string      | the table contains interaction terms or not                                                                                             |
| 50 | quadratic_term                                      | string      | the table contains quadratic terms or not                                                                                               |
| 51 | n                                                   | float       | number of observations                                                                                                                  |
| 52 | r2                                                  | float       | R square                                                                                                                                |
| 53 | beta                                                | float       | Beta coefficient                                                                                                                        |
| 54 | test_standard_error                                 | string      | check if sr really standard error by comparing beta divided by sr and critical values                                                   |
| 55 | test_p_value                                        | string      | check if sign and p value match                                                                                                         |
| 56 | test_t_value                                        | string      | check if t critial value and sign match                                                                                                 |
| 57 | adjusted_standard_error                             | float       | reconstructed standard error                                                                                                            |
| 58 | adjusted_t_value                                    | float       | reconstructed t value                                                                                                                   |
